...
CREATE TABLE "Match" (
    ...
    CONSTRAINT "Match_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ChatImage" (
    ...
    CONSTRAINT "ChatImage_chatId_fkey" FOREIGN KEY ("chatId") REFERENCES "Chat" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "Chat_matchId_updatedAt_idx" ON "Chat"("matchId", "updatedAt");

-- CreateIndex
CREATE INDEX "ChatImage_chatId_idx" ON "ChatImage"("chatId");
